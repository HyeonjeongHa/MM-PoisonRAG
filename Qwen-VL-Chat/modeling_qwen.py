...
class QWenModel(QWenPreTrainedModel):
    ...
    def forward(
        ...
        if past_key_values is None and torch.any(input_ids == self.config.visual['image_start_id']):
            ...
            if self.cur_image_tensor is None:
                images = []
                ...
                # print("Using the image tensor from the previous forward pass")
                images = self.visual(self.cur_image_tensor)            
            fake_images = None
        elif self.training:
...
class QWenLMHeadModel(QWenPreTrainedModel):
    ...
    def chat(
        ...
        **kwargs,
        ...
        self.transformer.cur_image_tensor = image_tensor
